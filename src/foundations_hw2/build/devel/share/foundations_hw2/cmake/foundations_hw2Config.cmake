...
if("TRUE" STREQUAL "TRUE")
  set(foundations_hw2_SOURCE_PREFIX /home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2)
  set(foundations_hw2_DEVEL_PREFIX /home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2/build/devel)
  ...
  set(foundations_hw2_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2/build/devel/include " STREQUAL " ")
  set(foundations_hw2_INCLUDE_DIRS "")
  set(_include_dirs "/home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2/build/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'foundations_hw2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'foundations_hw2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wil/projects/research/foundations-of-robotics/HW/coding/src/kinematics/src/foundations_hw2/build/devel/lib;/opt/ros/lunar/lib)
