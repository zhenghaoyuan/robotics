...
class RewardRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RewardRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RewardRequest
    let len;
    let data = new RewardRequest(null);
  ...
  static datatype() {
    ...
    return 'foundations_hw1/RewardRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RewardRequest(null);
...
class RewardResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RewardResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RewardResponse
    let len;
    let data = new RewardResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RewardResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'e4b5d32ae3ca1cd1c0a07d0712fcdd49'; },
  datatype() { return 'foundations_hw1/Reward'; }
};
