...
// (in-package foundations_hw1.srv)
...
class EscapeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EscapeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EscapeRequest
    let len;
    let data = new EscapeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EscapeRequest(null);
...
class EscapeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EscapeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EscapeResponse
    let len;
    let data = new EscapeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EscapeResponse(null);
...
module.exports = {
  ...
  md5sum() { return '89ed0fab02445014d3380c75507816b5'; },
  datatype() { return 'foundations_hw1/Escape'; }
};
