...
"""autogenerated by genpy from hw2/p3aRequest.msg. Do not edit."""
import sys
...
class p3aRequest(genpy.Message):
  _md5sum = "a7c84ff13976aa04656e56e300124444"
  _type = "hw2/p3aRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(p3aRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from hw2/p3aResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class p3aResponse(genpy.Message):
  _md5sum = "fb6e7c37be4d0e82de5529136096fb87"
  _type = "hw2/p3aResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(p3aResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class p3a(object):
  ...
  _request_class  = p3aRequest
  _response_class = p3aResponse
