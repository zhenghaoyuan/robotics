...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'foundations_hw2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cs4750/catkin/install/${idir}'.  Ask the maintainer 'Wil Thomason <wbthomason@cs.cornell.edu>' to fix it.")
    endif()
